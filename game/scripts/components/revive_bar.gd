...
## The stone that used to stand here for a downed partner is `DeathMarkers`'
## now (2026-09-14): one stone per hero down in every mode, falling, landing
## and dissolving on the revive, with the remains left behind. This draws
## the bar and the prompt over it and nothing else.
