...
const GROUPS: Dictionary = {
	...
	"sfx_boss_fall": ["sfx_boss_fall_1", "sfx_boss_fall_2", "sfx_boss_fall_3"],
	"sfx_boss_stinger": ["sfx_boss_stinger_1", "sfx_boss_stinger_2", "sfx_boss_stinger_3"],
	"sfx_camp_razed": ["sfx_camp_razed_1", "sfx_camp_razed_2", "sfx_camp_razed_3"],
	"sfx_chest_open": ["sfx_chest_open_1", "sfx_chest_open_2", "sfx_chest_open_3"],
	"sfx_chieftain_roar": ["sfx_chieftain_roar_1", "sfx_chieftain_roar_2", "sfx_chieftain_roar_3"],
	"sfx_companion_down": ["sfx_companion_down_1", "sfx_companion_down_2", "sfx_companion_down_3"],
	"sfx_companion_return": ["sfx_companion_return_1", "sfx_companion_return_2", "sfx_companion_return_3"],
	"sfx_companion_strike": ["sfx_companion_strike_1", "sfx_companion_strike_2", "sfx_companion_strike_3"],
	"sfx_companion_summon": ["sfx_companion_summon_1", "sfx_companion_summon_2", "sfx_companion_summon_3"],
	"sfx_drown": ["sfx_drown_1", "sfx_drown_2", "sfx_drown_3"],
	"sfx_dungeon_collapse": ["sfx_dungeon_collapse_1", "sfx_dungeon_collapse_2", "sfx_dungeon_collapse_3"],
	"sfx_dungeon_exit": ["sfx_dungeon_exit_1", "sfx_dungeon_exit_2", "sfx_dungeon_exit_3"],
	"sfx_fish_bite": ["sfx_fish_bite_1", "sfx_fish_bite_2", "sfx_fish_bite_3"],
	"sfx_fish_cast": ["sfx_fish_cast_1", "sfx_fish_cast_2", "sfx_fish_cast_3"],
	"sfx_fish_cast_charge": ["sfx_fish_cast_charge_1", "sfx_fish_cast_charge_2", "sfx_fish_cast_charge_3"],
	"sfx_fish_escape": ["sfx_fish_escape_1", "sfx_fish_escape_2", "sfx_fish_escape_3"],
	"sfx_fish_hook": ["sfx_fish_hook_1", "sfx_fish_hook_2", "sfx_fish_hook_3"],
	"sfx_fish_land": ["sfx_fish_land_1", "sfx_fish_land_2", "sfx_fish_land_3"],
	"sfx_fish_nibble": ["sfx_fish_nibble_1", "sfx_fish_nibble_2", "sfx_fish_nibble_3"],
	"sfx_fish_reel": ["sfx_fish_reel_1", "sfx_fish_reel_2", "sfx_fish_reel_3"],
	"sfx_fish_snap": ["sfx_fish_snap_1", "sfx_fish_snap_2", "sfx_fish_snap_3"],
	"sfx_fish_splash": ["sfx_fish_splash_1", "sfx_fish_splash_2", "sfx_fish_splash_3"],
	"sfx_fork_open": ["sfx_fork_open_1", "sfx_fork_open_2", "sfx_fork_open_3"],
	"sfx_meteor_impact": ["sfx_meteor_impact_1", "sfx_meteor_impact_2", "sfx_meteor_impact_3"],
	"sfx_meteor_whistle": ["sfx_meteor_whistle_1", "sfx_meteor_whistle_2", "sfx_meteor_whistle_3"],
	"sfx_party_accept": ["sfx_party_accept_1", "sfx_party_accept_2"],
	"sfx_party_decline": ["sfx_party_decline_1", "sfx_party_decline_2"],
	"sfx_party_prompt": ["sfx_party_prompt_1", "sfx_party_prompt_2", "sfx_party_prompt_3"],
	"sfx_profession_level": ["sfx_profession_level_1", "sfx_profession_level_2", "sfx_profession_level_3"],
	"sfx_quake": ["sfx_quake_1", "sfx_quake_2", "sfx_quake_3"],
	"sfx_raid_extract": ["sfx_raid_extract_1", "sfx_raid_extract_2", "sfx_raid_extract_3"],
	"sfx_raid_window": ["sfx_raid_window_1", "sfx_raid_window_2", "sfx_raid_window_3"],
	"sfx_swim_enter": ["sfx_swim_enter_1", "sfx_swim_enter_2", "sfx_swim_enter_3"],
	"sfx_swim_exit": ["sfx_swim_exit_1", "sfx_swim_exit_2", "sfx_swim_exit_3"],
	"sfx_swim_stroke": ["sfx_swim_stroke_1", "sfx_swim_stroke_2", "sfx_swim_stroke_3"],
	"sfx_thunder_far": ["sfx_thunder_far_1", "sfx_thunder_far_2", "sfx_thunder_far_3"],
	"sfx_thunder_near": ["sfx_thunder_near_1", "sfx_thunder_near_2", "sfx_thunder_near_3"],
	"sfx_tornado": ["sfx_tornado_1", "sfx_tornado_2", "sfx_tornado_3"],
	"sfx_water_bite": ["sfx_water_bite_1", "sfx_water_bite_2", "sfx_water_bite_3"],
	"sfx_well_drink": ["sfx_well_drink_1", "sfx_well_drink_2", "sfx_well_drink_3"],
