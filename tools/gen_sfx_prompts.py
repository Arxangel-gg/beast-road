...
ROWS = [
    ...
    ("sfx_quake", "sfx", "sfx", "3.2s", "ElevenLabs",
    ...
    ("sfx_meteor_impact", "sfx", "sfx", "2.4s", "ElevenLabs",
...
PLACEHOLDER_IDS = {
    "sfx_thunder_near", "sfx_thunder_far", "sfx_quake", "sfx_wildfire", "sfx_tornado",
    "sfx_meteor_whistle", "sfx_meteor_impact",
