...
- Live and persistent Video settings, labelled colourblind palette preview,
  and reversible shadow, foliage, cloud and particle budgets.
...
- `live_settings_check.tscn` passes seven live-apply and persistence checks.
- Tool-leak check passes for all 71 shipped scripts.
- Asset report passes with 133/133 real manifest assets and zero placeholders.
...
The automatable v4 conformance score now stands at 19/40 (48%). This is not yet a
...
The largest remaining production systems are the 24-node discipline system;
full enemy, elite,
...
Implement the 24-node Blood/Holy/Berserk discipline system as a data-driven
vertical slice, including Mansion offers, four active slots, respec rules,
controller navigation, save-safe unlocks, and combat telemetry.
